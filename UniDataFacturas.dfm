inherited dmFacturas: TdmFacturas
  ...
  object unqryLinFac: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO `vi_FACTURAS_LINEAS`'
      
        '  (`NRO_FACTURA_LINEA`, `SERIE_FACTURA_LINEA`, `LINEA_FACTURA_LI' +
        'NEA`, `CODIGO_ARTICULO_FACTURA_LINEA`, `CODIGO_FAMILIA_FACTURA_L' +
        'INEA`, `NOMBRE_FAMILIA_FACTURA_LINEA`, `FECHA_ENTREGA_FACTURA_LI' +
        'NEA`, `TIPO_CANTIDAD_ARTICULO_FACTURA_LINEA`, `ESIMP_INCL_TARIFA' +
        '_FACTURA_LINEA`, `TIPOIVA_ARTICULO_FACTURA_LINEA`, `DESCRIPCION_' +
        'ARTICULO_FACTURA_LINEA`, `CODIGO_TARIFA_FACTURA_LINEA`, `CANTIDA' +
        'D_FACTURA_LINEA`, `PRECIOSALIDA_FACTURA_LINEA`, `PORCEN_DTO_FACT' +
        'URA_LINEA`, `PRECIO_DTO_FACTURA_LINEA`, `PRECIOVENTA_SIVA_ARTICU' +
        'LO_FACTURA_LINEA`, `PORCEN_IVA_FACTURA_LINEA`, `PRECIOVENTA_CIVA' +
        '_ARTICULO_FACTURA_LINEA`, `TOTAL_FACTURA_LINEA`, `TOTAL_FACTURAS' +
        'IVA_LINEA`, `INSTANTEMODIF`, `INSTANTEALTA`, `USUARIOALTA`, `USU' +
        'ARIOMODIF`)'
      'VALUES'
      
        '  (:`NRO_FACTURA_LINEA`, :`SERIE_FACTURA_LINEA`, :`LINEA_FACTURA' +
        '_LINEA`, :`CODIGO_ARTICULO_FACTURA_LINEA`, :`CODIGO_FAMILIA_FACT' +
        'URA_LINEA`, :`NOMBRE_FAMILIA_FACTURA_LINEA`, :`FECHA_ENTREGA_FAC' +
        'TURA_LINEA`, :`TIPO_CANTIDAD_ARTICULO_FACTURA_LINEA`, :`ESIMP_IN' +
        'CL_TARIFA_FACTURA_LINEA`, :`TIPOIVA_ARTICULO_FACTURA_LINEA`, :`D' +
        'ESCRIPCION_ARTICULO_FACTURA_LINEA`, :`CODIGO_TARIFA_FACTURA_LINE' +
        'A`, :`CANTIDAD_FACTURA_LINEA`, :`PRECIOSALIDA_FACTURA_LINEA`, :`' +
        'PORCEN_DTO_FACTURA_LINEA`, :`PRECIO_DTO_FACTURA_LINEA`, :`PRECIO' +
        'VENTA_SIVA_ARTICULO_FACTURA_LINEA`, :`PORCEN_IVA_FACTURA_LINEA`,' +
        ' :`PRECIOVENTA_CIVA_ARTICULO_FACTURA_LINEA`, :`TOTAL_FACTURA_LIN' +
        'EA`, :`TOTAL_FACTURASIVA_LINEA`, :`INSTANTEMODIF`, :`INSTANTEALT' +
        'A`, :`USUARIOALTA`, :`USUARIOMODIF`)')
    SQLDelete.Strings = (
      'DELETE FROM `vi_FACTURAS_LINEAS`'
      'WHERE'
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        'MILIA_FACTURA_LINEA`, `FECHA_ENTREGA_FACTURA_LINEA` = :`FECHA_EN' +
        'TREGA_FACTURA_LINEA`, `TIPO_CANTIDAD_ARTICULO_FACTURA_LINEA` = :' +
        '`TIPO_CANTIDAD_ARTICULO_FACTURA_LINEA`, `ESIMP_INCL_TARIFA_FACTU' +
        'RA_LINEA` = :`ESIMP_INCL_TARIFA_FACTURA_LINEA`, `TIPOIVA_ARTICUL' +
        'O_FACTURA_LINEA` = :`TIPOIVA_ARTICULO_FACTURA_LINEA`, `DESCRIPCI' +
        'ON_ARTICULO_FACTURA_LINEA` = :`DESCRIPCION_ARTICULO_FACTURA_LINE' +
        'A`, `CODIGO_TARIFA_FACTURA_LINEA` = :`CODIGO_TARIFA_FACTURA_LINE' +
        'A`, `CANTIDAD_FACTURA_LINEA` = :`CANTIDAD_FACTURA_LINEA`, `PRECI' +
        'OSALIDA_FACTURA_LINEA` = :`PRECIOSALIDA_FACTURA_LINEA`, `PORCEN_' +
        'DTO_FACTURA_LINEA` = :`PORCEN_DTO_FACTURA_LINEA`, `PRECIO_DTO_FA' +
        'CTURA_LINEA` = :`PRECIO_DTO_FACTURA_LINEA`, `PRECIOVENTA_SIVA_AR' +
        'TICULO_FACTURA_LINEA` = :`PRECIOVENTA_SIVA_ARTICULO_FACTURA_LINE' +
        'A`, `PORCEN_IVA_FACTURA_LINEA` = :`PORCEN_IVA_FACTURA_LINEA`, `P' +
        'RECIOVENTA_CIVA_ARTICULO_FACTURA_LINEA` = :`PRECIOVENTA_CIVA_ART' +
        'ICULO_FACTURA_LINEA`, `TOTAL_FACTURA_LINEA` = :`TOTAL_FACTURA_LI' +
        'NEA`, `TOTAL_FACTURASIVA_LINEA` = :`TOTAL_FACTURASIVA_LINEA`, `I' +
        'NSTANTEMODIF` = :`INSTANTEMODIF`, `INSTANTEALTA` = :`INSTANTEALT' +
        'A`, `USUARIOALTA` = :`USUARIOALTA`, `USUARIOMODIF` = :`USUARIOMO' +
        'DIF`'
      'WHERE'
    ...
    SQLLock.Strings = (
        ...
        'RA_LINEA`, `NOMBRE_FAMILIA_FACTURA_LINEA`, `FECHA_ENTREGA_FACTUR' +
        'A_LINEA`, `TIPO_CANTIDAD_ARTICULO_FACTURA_LINEA`, `ESIMP_INCL_TA' +
        'RIFA_FACTURA_LINEA`, `TIPOIVA_ARTICULO_FACTURA_LINEA`, `DESCRIPC' +
        'ION_ARTICULO_FACTURA_LINEA`, `CODIGO_TARIFA_FACTURA_LINEA`, `CAN' +
        'TIDAD_FACTURA_LINEA`, `PRECIOSALIDA_FACTURA_LINEA`, `PORCEN_DTO_' +
        'FACTURA_LINEA`, `PRECIO_DTO_FACTURA_LINEA`, `PRECIOVENTA_SIVA_AR' +
        'TICULO_FACTURA_LINEA`, `PORCEN_IVA_FACTURA_LINEA`, `PRECIOVENTA_' +
        'CIVA_ARTICULO_FACTURA_LINEA`, `TOTAL_FACTURA_LINEA`, `TOTAL_FACT' +
        'URASIVA_LINEA`, `INSTANTEMODIF`, `INSTANTEALTA`, `USUARIOALTA`, ' +
        '`USUARIOMODIF` FROM `vi_FACTURAS_LINEAS`'
      'WHERE'
    ...
    SQLRefresh.Strings = (
      ...
      'WHERE'
        ...
        'NEA_FACTURA_LINEA`')
    SQLRecCount.Strings = (
      'SELECT COUNT(*) FROM vi_FACTURAS_LINEAS')
    Connection = dmConn.conUni
    SQL.Strings = (
      'SELECT *'
